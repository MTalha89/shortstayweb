        ...
        <div class="panel-body">
            ...
            <?php if(is_default_lang()): ?>
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="control-label"><?php echo e(__("Minimum hour stay requirements")); ?></label>
                            <input type="number" name="min_hour_stays" class="form-control" value="<?php echo e($row->min_hour_stays); ?>" placeholder="<?php echo e(__("Ex: 2")); ?>">
                            <i><?php echo e(__("Leave blank if you dont need to set minimum hour stay option")); ?></i>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/mrkreativez/public_html/shortstay.mrkreativez.com/modules/Hotel/Views/admin/hotel/pricing.blade.php ENDPATH**/ ?>