<form class="form bravo-form-register" method="post" action="<?php echo e(route('auth.register.store')); ?>">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="cnic" autocomplete="off" placeholder="<?php echo e(__('CNIC')); ?>">
        <i class="input-icon field-icon icofont-mail"></i>
...
<input id="file-upload" type="file" style="display:none;"/>
    ...
    <div class="form-group">
        <input type="date" class="form-control" name="birthday" autocomplete="off" placeholder="<?php echo e(__('BirthDay')); ?>">
        <i class="input-icon field-icon icofont-waiter-alt"></i>
    ...
    <div class="col-lg-4 col-md-12">
    <div class="form-group">
        <input type="text" class="form-control" name="address" autocomplete="off" placeholder="<?php echo e(__('Address')); ?>">
         <i class="input-icon field-icon icofont-mail"></i>
    ...
    <div class="col-lg-4 col-md-12">
       <div class="form-group">
        <input type="text" class="form-control" name="city" autocomplete="off" placeholder="<?php echo e(__('City')); ?>">
         <i class="input-icon field-icon icofont-mail"></i>
...
<?php /**PATH /home/mrkreativez/public_html/shortstay.mrkreativez.com/modules/Layout/auth/register-form.blade.php ENDPATH**/ ?>