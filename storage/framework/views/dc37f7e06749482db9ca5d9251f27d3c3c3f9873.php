                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <div class="form-content dropdown-toggle" data-toggle="dropdown">
                            <label class="form-label"><?php echo e(__('Pricing')); ?></label>
                            <div class="render">
                        ...
                        <div class="dropdown-menu select-guests-dropdown" >
                            <div class="dropdown-item-row">
                                <div class="label" data-input="per-day" @click="addPricingType('day')"><?php echo e(__('Per Day')); ?></div>
                            </div>
                            <div class="dropdown-item-row">
                                <div class="label" data-input="per-hour" @click="addPricingType('hour')"><?php echo e(__('Per Hour')); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php /**PATH /home/mrkreativez/public_html/shortstay.mrkreativez.com/themes/Mytravel/Hotel/Views/frontend/layouts/details/hotel-rooms.blade.php ENDPATH**/ ?>