<?php if(is_default_lang()): ?>
    <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label><?php echo e(__("Pricing")); ?> <span class="text-danger">*</span></label>
                <select required name="pricing" class="form-control">
                    <option <?php if($row->pricing == 'per-day'): ?> selected <?php endif; ?> value="per-day">Per Day</option>
                    <option <?php if($row->pricing == 'per-hour'): ?> selected <?php endif; ?>  value="per-hour">Per Hour</option>
                </select>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <hr>
<?php endif; ?><?php /**PATH /home/mrkreativez/public_html/shortstay.mrkreativez.com/modules/Hotel/Views/admin/room/form-detail/pricing.blade.php ENDPATH**/ ?>