          ...
          <div class="app-modal-card" data-name="settings" data-modal='0'>
              <form id="updateAvatar" action="<?php echo e(route('avatar.update')); ?>" enctype="multipart/form-data" method="POST">
                  ...
                  <div class="app-modal-body">
                      ...
                      style="background-image: url('<?php echo e(auth()->user()->getAvatarUrl()); ?>');"
                      ></div>
...
<?php /**PATH /home/mrkreativez/public_html/shortstay.mrkreativez.com/resources/views/vendor/Chatify/layouts/modals.blade.php ENDPATH**/ ?>